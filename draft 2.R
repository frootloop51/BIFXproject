...
file_names <- "/home/ijl1/Capstone/first_20_files.txt"
annotationfile <- "/home/ijl1/Capstone/annotation_file.bed"

outputs <- list()

for (file_name in file_names) {
  # Directly use the full path from the text file
  input_file <- file_name  # Full path is directly read from the text file
  ...
  outputs[[file_name]] <- coverage_output
}
