...
This plot confirms that employment is staying consistent across counties and time. Baltimore City is an exception, with a very narrow distribution that hovers near zero which indicates low employment per 100k residents. 

### Final Graphs

The exploratory analysis revealed that adjusting for population was necessary, that crime appeared to dropping over time, and that most counties had stable employment rates. This informed my decision to combine property and violent crime rates in the next set of graphs because violent crime rates are so low it would be difficult to compare it directly to employment rates.
...
All these graphs indicate that there is essentially no correlation between overall crime and employment rate. The lines are largely parallel showing that these data are not influencing one another.
